 ...
 *
 * ⚠️ לא "מעכשיו" — צריך מרווח כלשהו: הליד נוצר **בלי שיוך**, ומישהו
 * צריך לשבץ אותו לפני שהתזכורת יוצאת (10 דקות לפני השיחה).
 *
 * ⚠️ היה שעה, וזה היה יותר מדי: ב-13:39 השעה הראשונה שהוצעה הייתה
 * 15:00 — גם 14:00 וגם 14:30 נחתכו, והלקוח קיבל לוח שנראה ריק
 * בשעות שבהן הוא הכי זמין. רבע שעה עדיין מספיק לשיבוץ ולתזכורת,
 * ומחזיר את החצי-שעה הקרובה לרשימה.
 */
