...
/**
 * ⚠️ 12 ולא 10. הסף הקודם היה 10 תווים בלי שום דרישה נוספת, כלומר
 * `1234567890` ו-`aaaaaaaaaa` עברו אותו.
 *
 * ולא גבוה מ-12: הסיסמאות האלה מוקלדות בטלפון בין שיחות. מדיניות
 * שקשה מדי לעמוד בה לא מייצרת סיסמאות חזקות — היא מייצרת פתקים על
 * המסך, וזה מצב גרוע יותר מסיסמה בינונית.
 */
...
export function passwordProblem(
   ...
   * מעל 12 תווים נותנות מרחב גדול יותר בפועל, ואפשר לעמוד בה עם
