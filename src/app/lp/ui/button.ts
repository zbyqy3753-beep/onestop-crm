...
export const btnPrimary =
  "inline-flex min-h-11 items-center justify-center gap-2 rounded-lg bg-lp-brand px-4 py-2.5 text-sm font-semibold text-lp-ink-invert transition hover:bg-lp-brand-bright disabled:cursor-not-allowed disabled:opacity-40";

/** The alternative next to a primary — never two primaries side by side. */
export const btnSecondary =
  "inline-flex min-h-11 items-center justify-center gap-2 rounded-lg border border-lp-line bg-lp-surface px-4 py-2.5 text-sm font-medium text-lp-ink-2 transition hover:border-lp-brand hover:text-lp-brand";
...
export const btnAccent =
  "inline-flex min-h-11 items-center justify-center gap-2 rounded-lg bg-lp-brand-bright px-4 py-2 text-sm font-semibold text-lp-navy transition hover:bg-lp-brand-glow";

/** Quiet buttons sitting on a navy surface — hero category links, hero chips. */
export const btnOnNavy =
  "inline-flex min-h-11 items-center justify-center gap-2 rounded-lg bg-lp-navy-2 px-4 py-2.5 text-sm font-medium text-lp-on-navy transition hover:bg-lp-navy-3";
