...
export default async function AppLayout({
  ...
  return (
     ...
     * לראות את הכותרות.
     *
     * הוא **לא** מוגדר כאן יותר. שני המספרים שישבו כאן (`92px`/`60px`)
     * היו שגויים בטלפון: הסרגל הוא 52px ולא 60, והבאנר נשבר לשתי שורות
     * ב-360px ומגיע ל-~56px ולא ל-32. עכשיו הוא נגזר ב-`globals.css`
     * מ-`--banner-h` (נמדד בפועל) ומ-`--topbar-h` (מתחלף ב-breakpoint),
     * כך שאין מספר שאפשר לפספס. ראה ההערה שם.
     */
    <div>
      {realUser && (
        <ImpersonationBanner
